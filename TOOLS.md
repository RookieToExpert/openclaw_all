...
| 给某个 vc 开放，打开特权模式/ 给某个 vc 开放`disallow-privileged-containers`| `skills/hc-system-op/SKILL.md` | `tools/rayctl-kubectl.md` → policy update；`tools/hc-system-kubectl.md` → 8. `disallow-privileged-containers` policy 更新模板 |
